...
with(d,{plot(Sub_metering_1~DateTime,type="l",ylab="Global Active Power (kilowatts)",xlab=""); lines(Sub_metering_2~DateTime,lty=3,col="red"); lines(Sub_metering_3~DateTime,lty=3,col="blue")})
legend("topright",legend=c("Sub metering 1","Sub metering 2","Sub metering 3"),col=c("black","red","blue"),lty=1)
plot(d$Global_reactive_power~d$DateTime,type="l",ylab="Global Reactive Power (kilowatts)",xlab="datetime")
